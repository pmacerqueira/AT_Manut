...
${sa({tecnicoNome:a.tecnico??"—",tecnicoTelefone:x?.telefone??"",tecnicoAssinatura:x?.assinaturaDigital??"",clienteNome:a.nomeAssinante??"—",clienteAssinatura:a.assinaturaDigital??"",dataCriacao:M,dataAssinatura:B,declaracaoTexto:Z("reparacao"),proximasManutencoes:[]})}

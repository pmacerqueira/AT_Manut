import{a as $,e as N}from"./horasContadorEquipamento-B78EdVss.js";import{A as z}from"./index-D42kKAXQ.js";import{E as g}from"./empresa-pV7uX3IF.js";const o=N,e={azulNavel:"#1a4880",azulMedio:"#2d6eb5",vermelho:"#b91c1c",verde:"#15803d",amarelo:"#a16207",texto:"#111827",muted:"#374151",cinza:"#f3f4f6",cinzaBorda:"#b0c4de",branco:"#ffffff",bgAlt:"#f9fafb",bordaLeve:"#e5e7eb"},t={corpo:"10.5px",pequeno:"9.5px",label:"9px",micro:"8.5px",titulo:"11.5px",numSerie:"14px"};function A(r=e.azulNavel,i="rgba(26,72,128,0.12)"){return`
...
</header>`}function B(r,i,p,n=""){return`
...
<div class="rpt-acento" style="height:2px;background:linear-gradient(90deg,${e.azulNavel},${e.azulMedio});margin-bottom:8px;border-radius:0 0 2px 2px"></div>`}function j(r="",i="",p=""){const n=i?`${o(z)} · ${o(i)}`:o(z),s=p||`${o(g.web)} &nbsp;|&nbsp; ${o(g.telefones)}`;return`
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px"><tr>
    ...
    <td width="48%" style="vertical-align:top;padding-left:6px">
      <div style="${a.sigCol}">
        ...
        ${u?`<div style="margin-top:8px"><img src="${u}" alt="Assinatura do cliente" style="max-width:100%;max-height:80px;width:auto;height:auto;border:1px solid ${e.cinzaBorda};border-radius:3px;display:block"></div>`:`<div style="height:70px;border-bottom:1.5px dashed ${e.cinzaBorda};margin-top:8px"></div>`}
      </div>
    </td>
  </tr></table>`;if(h?.length>0){const c=h.sort((d,f)=>(d.data??"").localeCompare(f.data??"")).map((d,f)=>`<tr${f%2===1?` style="background:${e.cinza}"`:""}>
        <td style="${a.tdStyle};text-align:center;width:30px">${f+1}</td>
...
</div>`,v}function D(r=[],i="Documentação fotográfica"){if(!r.length)return"";const p=(l,x)=>`<div class="rpt-foto-item">
      <img src="${l}" alt="Fotografia ${x+1}">
      <div class="rpt-foto-caption">Foto ${x+1}</div>
    </div>`,n=l=>l===1?"rpt-fotos-row rpt-fotos-row--single":l===2?"rpt-fotos-row rpt-fotos-row--pair":l===3?"rpt-fotos-row rpt-fotos-row--triple":"rpt-fotos-row rpt-fotos-row--quad";let s="";for(let l=0;l<r.length;){const x=r.length-l,m=Math.min(4,x),h=n(m);s+=`<div class="${h}">`;for(let b=0;b<m;b++){const u=l+b;s+=p(r[u],u)}s+="</div>",l+=m}return`
<section class="section-can-break">
  <div class="rpt-section-title">${o(i)}</div>
  <div class="rpt-fotos-section">${s}</div>
</section>`}export{e as P,t as T,B as a,j as b,A as c,D as d,P as e,C as h};

...
| Testes | Playwright E2E — ver `docs/TESTES-E2E.md` (452 listados em 19 ficheiros); `npm run test:e2e` / `npm run test:e2e:last-failed` · Unitários: `npm run test:unit` (65 testes em `tests/unit/`) |

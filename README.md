...
| Testes | Playwright E2E — ver `docs/TESTES-E2E.md` (456 listados em 19 ficheiros; spec 18 em skip); `npm run test:e2e` / `npm run test:e2e:last-failed` · Unitários: `npm run test:unit` (35 testes em `tests/unit/`) |

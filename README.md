...
| Testes | Playwright E2E — ver `docs/TESTES-E2E.md` (458 listados em 20 ficheiros; spec 18 em skip); `npm run test:e2e` / `npm run test:e2e:last-failed` · Unitários: `npm run test:unit` (65 testes em `tests/unit/`) |
